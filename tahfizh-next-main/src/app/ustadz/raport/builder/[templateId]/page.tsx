...
/**
 * TAHFIZH V13 — Guru boleh menyunting layout template milik lembaganya
 * dan menyimpannya. Template global (tenant_id null) tetap milik Developer.
 */
export default async function UstadzReportBuilderPage({
  params,
}: {
  params: Promise<{ templateId: string }>;
}) {
  const profile = await requireRole(["USTADZ"], "/ustadz/raport");
