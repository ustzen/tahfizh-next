...
export default async function SantriObrolanPage() {
  const profile = await requireRole(["WALI_SANTRI"], "/santri/obrolan");
  ...
  return (
    <div>
      ...
      />
      <ChatPanel rooms={rooms} initialRoomId={null} initialMessages={messages} canModerate={false} />
    </div>
  );
}
